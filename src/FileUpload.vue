...
.file-upload
  ...
  .input-wrapper(:style='inputWrapperStyle')
    input#'inputId'(type='file', name='file', @change='onChangeInputFile', :accept='accept', :multiple='false', :disabled='uploading', ref='input')
    label.file-upload-label(:for='inputId')
